...
/**
 * Compute a multivariate gaussian probability
 * @param  {double} sig_x : standard deviation in x direction
 * @param  {double} sig_y : standard deviation in y direction
 * @param  {double} x_obs : x of the observation
 * @param  {double} y_obs : y of the observation
 * @param  {double} mu_x  : mean in x direction
 * @param  {double} mu_y  : mean in y direction
